...
public class Bag {
	...
	/**
	 * Méthode récupérant les objets du sac
	 * 
	 * @return
	 */
	...
	/**
	 * Méthode permettant d'ajouter un objet dans le sac
	 * 
	 * @param item
	...
	/**
	 * Méthode permettant d'enlever un item du sac
	 * 
	 * @param item
	 * @return
	 */
	...
	/**
	 * Méthode permettant le trasnfert du sac 'from' vers le sac 'into'
	 * 
	 * @param from
	 * @param into
	 * @throws BagFullException
