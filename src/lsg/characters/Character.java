...
public abstract class Character {
	...
	/**
	 * Méthode permmettant de savoir si le character est vivant
	 * 
	 * @return
	 */
	...
	/**
	 * Méthode permettant de gérer les dommages suivant l'arme et les buffs
	 * 
	 * @param weapon
	 * @return
	...
	/**
	 * Méthodes permettant de déclancher une attaque
	 * 
	 * @return
	 * @throws WeaponNullException
	 * @throws WeaponBrokenException
	...
	/**
	 * Méthode permettant de gérer le fait qu'un personnage se fasse attaquer. On
	...
	/**
	 * Méthode permettant de définir un combat entre un hero et un monster
	 * 
	 * @param monster
	 * @throws WeaponNullException
	 * @throws WeaponBrokenException
	...
	/**
	 * Méthode abstraite permettant de prendre en compte l'armure d'un Character
	 * 
	 * @return
	 */
	...
	/**
	 * Méthode permettant de prendre en compte les buffs d'un Character
	 * 
	 * @return
	 */
	...
	/**
	 * Méthode permettant l'utilisation d'un Consomable de rendant de la stamina
	 * 
	 * @param drink
	 * @return
	...
	/**
	 * Méthode permettant l'utilisation d'un Consomable de rendant de la vie (life)
	 * 
	 * @param food
	 * @return
	 * @throws ConsumeNullException
	...
	/**
	 * Méthode permettant d'utiliser un consomable
	 * 
	 * @param consumable
	 * @throws ConsumeNullException
	 * @throws ConsumeEmptyException
	...
	/**
	 * Méthode permettant d'utiliser un kit de réparation pour une arme
	 * 
	 * @param kit
	 * @throws WeaponNullException
	 */
	...
	/**
	 * Méthode permettant d'utiliser un consumable dans un sac
	 * 
	 * @throws ConsumeNullException
	 * @throws ConsumeEmptyException
	 * @throws ConsumeRepairNullWeaponException
	...
	/**
	 * Méthode permettant de récupérer un objet et le mettre dans le sac du héro
	 * 
	 * @param item
	...
	/**
	 * Méthode permettant de sortir un objet du sac
	 * 
	 * @param item
	 * @return
	 * @throws NoBagException
	...
	/**
	 * Méthode permettant d'afficher le contenu d'un sac
	 */
	...
	/**
	 * Méthode retournant la capacity d'un sac
	 * 
	 * @return
	 */
	...
	/*
	 * Méthode retournant le poids restant dans un sac
	 */
	...
	/**
	 * Méthode retournant un tableau contenant les items du sac
	 * 
	 * @return
	 * @throws NoBagException
	 */
	...
	/**
	 * Méthode permettant d'équiper un sac a un hero
	 * 
	 * @param bag
	 * @return
	 * @throws BagFullException
	...
	/**
	 * Méthode permettant d'équiper une arme provenant d'un sac
	 * 
	 * @param weapon
	 * @throws NoBagException
	 */
	...
	/**
	 * Méthode permettant d'équiper un consomable provenant d'un sac
	 * 
	 * @param consumable
	 * @throws NoBagException
	 */
	...
	/**
	 * Méthode permettant l'utilisation rapide d'un consomable étant dans le sac
	 * 
	 * @param type
	 * @return
	 * @throws ConsumeNullException
	...
	/**
	 * Méthode permettant la consommation rapide d'un objet rendant de la stamina
	 * 
	 * @return
	 * @throws ConsumeNullException
	 * @throws ConsumeEmptyException
	...
	/**
	 * Méthode permettant la consommation rapide d'un objet rendant de la vie (life)
	 * 
	 * @return
	 * @throws ConsumeNullException
	 * @throws ConsumeEmptyException
	...
	/**
	 * Méthode permettant la consomation rapide d'un kit de réparation
	 * 
	 * @return
	 * @throws ConsumeNullException
	 * @throws ConsumeEmptyException
	...
	/**
	 * Méthode affichant le consommable équiper par le héro
	 */
	...
	/**
	 * Méthode affichant l'amre équipé du héro
	 */
